...
//    UILabel* label = [[UILabel alloc] initWithFrame:CGRectMake(60, 120, 100, 50)];
//    label.backgroundColor = [[UIColor alloc] initWithHex:@"c7f464" alpha:1];
...
-(void) animateColor: (NSNumber*) cpIndex{
    int index = [cpIndex intValue]; //convert from NSNumber to int
